...
public class BmiServiceTest {
    ...
    public void 存在するユーザーのIDを指定したときに正常にユーザーが返されること() throws Exception {
        ...
        doReturn(Optional.of(new BodyData(1, "タナカ　イチロウ", 20, 171.5, 60.2, 20.46766228357232))).when(bmiMapper).findById(1);

        //act
        BodyData actual = bmiService.findName(1);

        //assert
        assertThat(actual).isEqualToComparingFieldByField(new BodyData(1, "タナカ　イチロウ", 20, 171.5, 60.2, 20.46766228357232));

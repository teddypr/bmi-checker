...
class BmiMapperTest {
    ...
    void 指定した名前の頭文字で従業員情報が正常に返されること() {
        ...
        assertThat(bodyDataList.get(1)).isEqualTo(new BodyData(1, "タナカ　イチロウ", 20, 171.5, 60.2));
        assertThat(bodyDataList.get(0)).isEqualTo(new BodyData(4, "タカハシ　カズキ", 31, 170.6, 67.8));
    }
